<template>
  <v-container class="pa-6">
    <v-card class="pa-6">
      ...
      <p>PCMaster<br>Alfred-Wachtel-Straße 8,<br>78462 Konstanz</p>
      <p>E-Mail-Adresse: <a href="mailto:kontakt@pcmaster.de">kontakt@pcmaster.de</a></p>
      ...
      <ul>
        ...
        <li><strong>Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO)</strong> - die Verarbeitung ist zur
          Wahrung der berechtigten Interessen des Verantwortlichen oder eines Dritten notwendig, vorausgesetzt, dass die
      ...
      <p>Sicherung von Online-Verbindungen durch TLS-/SSL-Verschlüsselungstechnologie (HTTPS): Um die Daten der Nutzer,
        die über unsere Online-Dienste übertragen werden, vor unerlaubten Zugriffen zu schützen, setzen wir auf die
        ...
        zwischen der Website oder App und dem Browser des Nutzers (oder zwischen zwei Servern) übertragen werden,
        wodurch die Daten vor unbefugtem Zugriff geschützt sind. TLS, als die weiterentwickelte und sicherere Version
        von SSL, gewährleistet, dass alle Datenübertragungen den höchsten Sicherheitsstandards entsprechen. Wenn eine
        Website durch ein SSL-/TLS-Zertifikat gesichert ist, wird dies durch die Anzeige von HTTPS in der URL
        signalisiert. Dies dient als ein Indikator für die Nutzer, dass ihre Daten sicher und verschlüsselt übertragen
        werden.</p>
        ...
        <li><strong>Aufbewahrung und Löschung von Daten: </strong>Die folgenden allgemeinen Fristen gelten für die
          ...
          <ul>
            <li>10 Jahre - Aufbewahrungsfrist für Bücher und Aufzeichnungen, Jahresabschlüsse, Inventare, Lageberichte,
              ...
              Organisationsunterlagen (§ 147 Abs. 1 Nr. 1 i.V.m. Abs. 3 AO, § 14b Abs. 1 UStG, § 257 Abs. 1 Nr. 1 i.V.m.
              Abs. 4 HGB).
            </li>
            <li>8 Jahre - Buchungsbelege, wie z. B. Rechnungen und Kostenbelege (§ 147 Abs. 1 Nr. 4 und 4a i.V.m. Abs. 3
              Satz 1 AO sowie § 257 Abs. 1 Nr. 4 i.V.m. Abs. 4 HGB).
            </li>
            <li>6 Jahre - Übrige Geschäftsunterlagen: empfangene Handels- oder Geschäftsbriefe, Wiedergaben der
              ...
              Preisauszeichnungen, aber auch Lohnabrechnungsunterlagen, soweit sie nicht bereits Buchungsbelege sind und
              Kassenstreifen (§ 147 Abs. 1 Nr. 2, 3, 5 i.V.m. Abs. 3 AO, § 257 Abs. 1 Nr. 2 u. 3 i.V.m. Abs. 4 HGB).
            </li>
      ...
      <p>Wir verarbeiten Daten unserer Vertrags- und Geschäftspartner, z. B. Kunden und Interessenten (zusammenfassend
        als „Vertragspartner" bezeichnet), im Rahmen von vertraglichen und vergleichbaren Rechtsverhältnissen sowie
        damit verbundenen Maßnahmen und im Hinblick auf die Kommunikation mit den Vertragspartnern (oder
        vorvertraglich), etwa zur Beantwortung von Anfragen.</p>
      <p>Wir verwenden diese Daten, um unsere vertraglichen Verpflichtungen zu erfüllen. Dazu gehören insbesondere die
        Pflichten zur Erbringung der vereinbarten Leistungen, etwaige Aktualisierungspflichten und Abhilfe bei
        Gewährleistungs- und sonstigen Leistungsstörungen. Darüber hinaus verwenden wir die Daten zur Wahrung unserer
        Rechte und zum Zwecke der mit diesen Pflichten verbundenen Verwaltungsaufgaben sowie der
        Unternehmensorganisation. Zudem verarbeiten wir die Daten auf Grundlage unserer berechtigten Interessen sowohl
        an einer ordnungsgemäßen und betriebswirtschaftlichen Geschäftsführung als auch an Sicherheitsmaßnahmen zum
        Schutz unserer Vertragspartner und unseres Geschäftsbetriebs vor Missbrauch, Gefährdung ihrer Daten,
        Geheimnisse, Informationen und Rechte (z. B. zur Beteiligung von Telekommunikations-, Transport- und sonstigen
        Hilfsdiensten sowie Subunternehmern, Banken, Steuer- und Rechtsberatern, Zahlungsdienstleistern oder
        Finanzbehörden). Im Rahmen des geltenden Rechts geben wir die Daten von Vertragspartnern nur insoweit an Dritte
        weiter, als dies für die vorgenannten Zwecke oder zur Erfüllung gesetzlicher Pflichten erforderlich ist. Über
        weitere Formen der Verarbeitung, etwa zu Marketingzwecken, werden die Vertragspartner im Rahmen dieser
        Datenschutzerklärung informiert.</p>
      <p>Welche Daten für die vorgenannten Zwecke erforderlich sind, teilen wir den Vertragspartnern vor oder im Rahmen
        der Datenerhebung, z. B. in Onlineformularen, durch besondere Kennzeichnung (z. B. Farben) bzw. Symbole (z. B.
        Sternchen o. Ä.), oder persönlich mit.</p>
      <p>Wir löschen die Daten nach Ablauf gesetzlicher Gewährleistungs- und vergleichbarer Pflichten, d. h.
        ...
        solange sie aus gesetzlichen Gründen der Archivierung aufbewahrt werden müssen (etwa für Steuerzwecke im
        Regelfall zehn Jahre). Daten, die uns im Rahmen eines Auftrags durch den Vertragspartner offengelegt wurden,
        löschen wir entsprechend den Vorgaben und grundsätzlich nach Ende des Auftrags.</p>
      <ul class="m-elements">
        <li><strong>Verarbeitete Datenarten:</strong> Bestandsdaten (z. B. der vollständige Name, Wohnadresse,
          ...
          Vertragsgegenstand, Laufzeit, Kundenkategorie); Nutzungsdaten (z. B. Seitenaufrufe und Verweildauer,
          Klickpfade, Nutzungsintensität und -frequenz, verwendete Gerätetypen und Betriebssysteme, Interaktionen mit
        ...
        <li><strong>Betroffene Personen:</strong> Leistungsempfänger und Auftraggeber; Interessenten. Geschäfts- und
          Vertragspartner.
        </li>
        ...
        <li class=""><strong>Rechtsgrundlagen:</strong> Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S.
          1 lit. b) DSGVO); Rechtliche Verpflichtung (Art. 6 Abs. 1 S. 1 lit. c) DSGVO). Berechtigte Interessen (Art. 6
          Abs. 1 S. 1 lit. f) DSGVO).
        </li>
      </ul>
      <p><strong>Weitere Hinweise zu Verarbeitungsprozessen, Verfahren und Diensten:</strong></p>
      <ul class="m-elements">
        <li><strong>Onlineshop, Bestellformulare, E-Commerce und Auslieferung: </strong>Wir verarbeiten die Daten
          unserer Kunden, um ihnen die Auswahl, den Erwerb, bzw. die Bestellung der gewählten Produkte, Waren sowie
          verbundener Leistungen, als auch deren Bezahlung und Zustellung, bzw. Ausführung zu ermöglichen. Sofern für
          die Ausführung einer Bestellung erforderlich, setzen wir Dienstleister, insbesondere Post-, Speditions- und
          Versandunternehmen ein, um die Lieferung, bzw. Ausführung gegenüber unseren Kunden durchzuführen. Für die
          Abwicklung der Zahlungsvorgänge nehmen wir die Dienste von Banken und Zahlungsdienstleistern in Anspruch. Die
          erforderlichen Angaben sind als solche im Rahmen des Bestell- bzw. vergleichbaren Erwerbsvorgangs
          gekennzeichnet und umfassen die zur Auslieferung, bzw. Zurverfügungstellung und Abrechnung benötigten Angaben
          sowie Kontaktinformationen, um etwaige Rücksprache halten zu können; <span
      ...
      <p>Personenbezogene Daten von Leistungsempfängern und Auftraggebern – darunter Kunden, Klienten oder in speziellen
        Fällen Mandanten, Patienten oder Geschäftspartner sowie weitere Dritte – werden im Rahmen vertraglicher sowie
        vergleichbarer Rechtsverhältnisse und vorvertraglicher Maßnahmen wie der Anbahnung von Geschäftsbeziehungen
        verarbeitet. Diese Datenverarbeitung unterstützt und erleichtert betriebswirtschaftliche Abläufe in Bereichen
        wie Kundenmanagement, Vertrieb, Zahlungsverkehr, Buchhaltung und Projektmanagement.</p>
      <p>Die erfassten Daten dienen dazu, vertragliche Verpflichtungen zu erfüllen und betriebliche Prozesse effizient
        zu gestalten. Hierzu gehört die Abwicklung von Geschäftstransaktionen, das Management von Kundenbeziehungen, die
        Optimierung von Vertriebsstrategien sowie die Gewährleistung interner Rechnungs- und Finanzprozesse. Zusätzlich
        unterstützen die Daten die Wahrung der Rechte des Verantwortlichen und fördern Verwaltungsaufgaben sowie die
        Organisation des Unternehmens.</p>
      <p>Personenbezogene Daten können an Dritte weitergegeben werden, sofern dies zur Erfüllung der genannten Zwecke
        oder gesetzlicher Verpflichtungen notwendig<span class="dsg-license-content-blurred de dsg-ttip-activate"
                                                         title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext </span>
      </p>
      <ul class="m-elements">
        <li><strong>Verarbeitete Datenarten:</strong> Bestandsdaten (z. B. der vollständige Name, Wohnadresse,
          Kontaktinformationen, Kundennummer,<span class="dsg-license-content-blurred de dsg-ttip-activate"
                                                   title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext premiumtext </span>);
          Zahlungsdaten (z. B. Bankverbindungen, Rechnungen, Zahlungshistorie<span
              class="dsg-license-content-blurred de dsg-ttip-activate"
              title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext </span>);
          Kontaktdaten (z. B. Post- und E-Mail-Adressen oder<span
              class="dsg-license-content-blurred de dsg-ttip-activate"
              title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext premiumtext </span>);
          Inhaltsdaten (z. B. textliche oder bildliche Nachrichten und Beiträge sowie die sie betreffenden
          Informationen, wie z. B. Angaben zur Autorenschaft<span
              class="dsg-license-content-blurred de dsg-ttip-activate"
              title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext </span>);
          Vertragsdaten (z. B. Vertragsgegenstand, Laufzeit, Kundenkategorie<span
              class="dsg-license-content-blurred de dsg-ttip-activate"
              title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext </span>);
          Nutzungsdaten (z. B. Seitenaufrufe und Verweildauer, Klickpfade, Nutzungsintensität und -frequenz, verwendete
          Gerätetypen und Betriebssysteme, Interaktionen mit<span
              class="dsg-license-content-blurred de dsg-ttip-activate"
              title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext premiumtext premiumtext premiumtext </span>);
          Meta-, Kommunikations- und Verfahrensdaten (z. B. IP-Adressen, Zeitangaben, Identifikationsnummern, beteiligte<span
              class="dsg-license-content-blurred de dsg-ttip-activate"
              title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext premiumtext </span>);
          Protokolldaten (z. B. Logfiles betreffend Logins oder den Abruf von Daten<span
              class="dsg-license-content-blurred de dsg-ttip-activate"
              title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext premiumtext premiumtext </span>).
          Bonitätsdaten (z.B. erhaltener Bonitätsscore, geschätzte Ausfallwahrscheinlichkeit, darauf basierende
          Risikoeinstufung,<span class="dsg-license-content-blurred de dsg-ttip-activate"
                                 title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext premiumtext premiumtext </span>).
        </li>
        <li><strong>Betroffene Personen:</strong> Leistungsempfänger und Auftraggeber; Interessenten;
          Kommunikationspartner; Geschäfts- und Vertragspartner; Kunden; Dritte Personen; Nutzer (z. B.
          Webseitenbesucher, Nutzer von<span class="dsg-license-content-blurred de dsg-ttip-activate"
                                             title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext premiumtext </span>).
          Beschäftigte (z. B. Angestellte, Bewerber, Aushilfskräfte und sonstige<span
              class="dsg-license-content-blurred de dsg-ttip-activate"
              title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext premiumtext </span>).
        </li>
        <li><strong>Zwecke der Verarbeitung:</strong> Erbringung vertraglicher Leistungen und Erfüllung vertraglicher
          ...
          Marketing; Absatzförderung; Öffentlichkeitsarbeit; Beurteilung der Bonität und Kreditwürdigkeit; Finanz- und
          Zahlungsmanagement. Informationstechnische Infrastruktur (Betrieb und Bereitstellung von Informationssystemen
          und technischen Geräten (Computer,<span class="dsg-license-content-blurred de dsg-ttip-activate"
                                                  title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext premiumtext premiumtext </span>).
        </li>
        <li><strong>Aufbewahrung und Löschung:</strong> Löschung entsprechend Angaben im Abschnitt "Allgemeine
          Informationen zur Datenspeicherung und Löschung".
        ...
        <li class=""><strong>Rechtsgrundlagen:</strong> Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S.
          1 lit. b) DSGVO); Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO). Rechtliche Verpflichtung (Art. 6
          Abs. 1 S. 1 lit. c) DSGVO).
        </li>
      </ul>
      <p><strong>Weitere Hinweise zu Verarbeitungsprozessen, Verfahren und Diensten:</strong></p>
      <ul class="m-elements">
        <li><strong>Kontaktverwaltung und Kontaktpflege: </strong>Verfahren, die im Rahmen der Organisation, Pflege und
          Sicherung von Kontaktinformationen erforderlich sind (z. B. die Einrichtung und Wartung einer zentralen
          Kontaktdatenbank, regelmäßige Aktualisierungen der Kontaktinformationen, Überwachung der Datenintegrität,
          Implementierung von Datenschutzmaßnahmen, Sicherstellung der Zugriffskontrollen, Durchführung von Backups und
          Wiederherstellungen der Kontaktdaten, Schulung von Mitarbeitern im effektiven<span
              class="dsg-license-content-blurred de dsg-ttip-activate"
              title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext </span>;
          <span class=""><strong>Rechtsgrundlagen:</strong> Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO), Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).</span>
        </li>
        <li><strong>Kundenkonto: </strong>Kunden können innerhalb unseres Onlineangebotes ein Konto anlegen (z. B.
          ...
          Registrierung sowie anschließender Anmeldungen und Nutzungen des Kundenkontos speichern wir die IP-Adressen
          der Kunden nebst den Zugriffszeitpunkten, um die Registrierung nachweisen und etwaigem Missbrauch des
          Kundenkontos vorbeugen zu können. Wurde das Kundenkonto gekündigt, werden die Daten des Kundenkontos nach dem
          Kündigungszeitpunkt gelöscht, sofern sie nicht für andere Zwecke als die Bereitstellung im Kundenkonto
          aufbewahrt werden oder aus rechtlichen Gründen aufbewahrt werden müssen (z. B. interne Speicherung von
          Kundendaten, Bestellvorgängen oder Rechnungen). Es liegt in der Verantwortung der Kunden, ihre Daten bei
          Kündigung des Kundenkontos zu sichern; <span class=""><strong>Rechtsgrundlagen:</strong> Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO), Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).</span>
        </li>
        <li><strong>Allgemeiner Zahlungsverkehr: </strong>Verfahren, die bei der Durchführung von Zahlungsvorgängen, der
          Überwachung von Bankkonten und der Kontrolle von Zahlungsströmen erforderlich sind (z. B. Erstellung und
          Prüfung von Überweisungen, Abwicklung des Lastschriftverkehrs, Kontrolle von Kontoauszügen, Überwachung<span
              class="dsg-license-content-blurred de dsg-ttip-activate"
              title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext </span>;
          <span class=""><strong>Rechtsgrundlagen:</strong> Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO), Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).</span>
        </li>
        <li><strong>Buchhaltung, Kreditorenbuchhaltung, Debitorenbuchhaltung: </strong>Verfahren, die bei der Erfassung,
          Bearbeitung und Kontrolle von Geschäftsvorgängen im Bereich der Kreditoren- und Debitorenbuchhaltung
          erforderlich sind (z. B. Erstellung und Prüfung von eingehenden und ausgehenden Rechnungen, Überwachung und
          Verwaltung von offenen Posten, Durchführung des Zahlungsverkehrs, Abwicklung des Mahnwesens,
          Kontenabstimmung<span class="dsg-license-content-blurred de dsg-ttip-activate"
                                title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext </span>;
          <span class=""><strong>Rechtsgrundlagen:</strong> Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO), Rechtliche Verpflichtung (Art. 6 Abs. 1 S. 1 lit. c) DSGVO), Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).</span>
        </li>
        <li><strong>Finanzbuchhaltung und Steuern: </strong>Verfahren, die bei der Erfassung, Verwaltung und Kontrolle
          von finanzrelevanten Geschäftsvorfällen sowie bei der Berechnung, Meldung und Zahlung von Steuern erforderlich
          sind (z. B. Kontierung und Verbuchung von Geschäftsvorfällen, Erstellung von Quartals- und Jahresabschlüssen,
          Durchführung des Zahlungsverkehrs, Abwicklung des Mahnwesens, Kontenabstimmung,<span
              class="dsg-license-content-blurred de dsg-ttip-activate"
              title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext </span>;
          <span class=""><strong>Rechtsgrundlagen:</strong> Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO), Rechtliche Verpflichtung (Art. 6 Abs. 1 S. 1 lit. c) DSGVO), Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).</span>
        </li>
        <li><strong>Marketing, Werbung und Absatzförderung: </strong>Verfahren, die im Rahmen von Marketing, Werbung und
          Absatzförderung erforderlich sind (z. B. Marktanalyse und Zielgruppenbestimmung, Entwicklung von
          ...
          Messebeteiligungen, Kundenbindungsprogramme,<span class="dsg-license-content-blurred de dsg-ttip-activate"
                                                            title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext </span>;
          <span
              class=""><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).</span>
        </li>
        <li><strong>Öffentlichkeitsarbeit: </strong>Verfahren, die im Rahmen der Öffentlichkeitsarbeit und Public
          Relations erforderlich sind (z. B. Entwicklung und Umsetzung von Kommunikationsstrategien, Planung und
          Durchführung von PR-Kampagnen, Erstellung und Verbreitung von Pressemitteilungen, Pflege von Medienkontakten,
          Monitoring und Analyse der Medienresonanz, Organisation von Pressekonferenzen und öffentlichen
          Veranstaltungen, Krisenkommunikation, Erstellung von<span
              class="dsg-license-content-blurred de dsg-ttip-activate"
              title="Bitte erwerben Sie eine Lizenz, um die Texte freizuschalten."> - Dieser Textbereich muss mit einer Premium Lizenz freischaltet werden. - premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext premiumtext </span>;
          <span
              class=""><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).</span>
      ...
      <p>Im Rahmen von Vertrags- und sonstigen Rechtsbeziehungen, aufgrund gesetzlicher Pflichten oder sonst auf
        ...
        (zusammenfassend "Zahlungsdienstleister").</p>
      ...
      <ul class="m-elements">
        <li><strong>Verarbeitete Datenarten:</strong> Bestandsdaten (z. B. der vollständige Name, Wohnadresse,
          Kontaktinformationen, Kundennummer, etc.); Zahlungsdaten (z. B. Bankverbindungen, Rechnungen,
          Zahlungshistorie); Vertragsdaten (z. B. Vertragsgegenstand, Laufzeit, Kundenkategorie); Nutzungsdaten (z. B.
          ...
          IP-Adressen, Zeitangaben, Identifikationsnummern, beteiligte Personen). Kontaktdaten (z. B. Post- und
          E-Mail-Adressen oder Telefonnummern).
        </li>
        <li><strong>Betroffene Personen:</strong> Leistungsempfänger und Auftraggeber; Geschäfts- und Vertragspartner.
          Interessenten.
        </li>
        <li><strong>Zwecke der Verarbeitung:</strong> Erbringung vertraglicher Leistungen und Erfüllung vertraglicher
      ...
      <p><strong>Weitere Hinweise zu Verarbeitungsprozessen, Verfahren und Diensten:</strong></p>
      <ul class="m-elements">
        <li><strong>Apple Pay: </strong>Zahlungsdienstleistungen (technische Anbindung von Online-Bezahlmethoden);
          <strong>Dienstanbieter:</strong> Apple Inc., Infinite Loop, Cupertino, CA 95014, USA; <span class=""><strong>Rechtsgrundlagen:</strong> Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO); </span><strong>Website:</strong>
          <a href="https://www.apple.com/de/apple-pay/" target="_blank">https://www.apple.com/de/apple-pay/</a>.
        ...
        <li><strong>Mastercard: </strong>Zahlungsdienstleistungen (technische Anbindung von Online-Bezahlmethoden);
          <strong>Dienstanbieter:</strong> Mastercard Europe SA, Chaussée de Tervuren 198A, B-1410 Waterloo, Belgien;
          <span class=""><strong>Rechtsgrundlagen:</strong> Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO); </span><strong>Website:</strong>
          <a href="https://www.mastercard.de/de-de.html" target="_blank">https://www.mastercard.de/de-de.html</a>.
          <strong>Datenschutzerklärung:</strong> <a href="https://www.mastercard.de/de-de/datenschutz.html"
                                                    target="_blank">https://www.mastercard.de/de-de/datenschutz.html</a>.
        </li>
        <li><strong>PayPal: </strong>Zahlungsdienstleistungen (technische Anbindung von Online-Bezahlmethoden) (z. B.
          PayPal, PayPal Plus, Braintree); <strong>Dienstanbieter:</strong> PayPal (Europe) S.à r.l. et Cie, S.C.A.,
          22-24 Boulevard Royal, L-2449 Luxemburg; <span class=""><strong>Rechtsgrundlagen:</strong> Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO); </span><strong>Website:</strong>
          <a href="https://www.paypal.com/de" target="_blank">https://www.paypal.com/de</a>. <strong>Datenschutzerklärung:</strong>
        ...
        <li><strong>Visa: </strong>Zahlungsdienstleistungen (technische Anbindung von Online-Bezahlmethoden); <strong>Dienstanbieter:</strong>
          Visa Europe Services Inc., Zweigniederlassung London, 1 Sheldon Square, London W2 6TT, GB; <span
              class=""><strong>Rechtsgrundlagen:</strong> Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO); </span><strong>Website:</strong>
          <a href="https://www.visa.de" target="_blank">https://www.visa.de</a>; <strong>Datenschutzerklärung:</strong>
          ...
          <strong>Grundlage Drittlandtransfers:</strong> Angemessenheitsbeschluss (GB).
        </li>
      </ul>
      ...
      <ul class="m-elements">
        ...
        <li><strong>Erhebung von Zugriffsdaten und Logfiles: </strong>Der Zugriff auf unser Onlineangebot wird in Form
          ...
          Auslastung der Server und ihre Stabilität sicherzustellen; <span class=""><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO). </span><strong>Löschung
      ...
      <p>Unter dem Begriff „Cookies" werden Funktionen, die Informationen auf Endgeräten der Nutzer speichern und aus
        ihnen auslesen, verstanden. Cookies können ferner in Bezug auf unterschiedliche Anliegen Einsatz finden, etwa zu
        Zwecken der Funktionsfähigkeit, der Sicherheit und des Komforts von Onlineangeboten sowie der Erstellung von
        Analysen der Besucherströme. Wir verwenden Cookies gemäß den gesetzlichen Vorschriften. Dazu holen wir, wenn
        erforderlich, vorab die Zustimmung der Nutzer ein. Ist eine Zustimmung nicht notwendig, setzen wir auf unsere
        berechtigten Interessen. Dies gilt, wenn das Speichern und Auslesen von Informationen unerlässlich ist, um
        ausdrücklich angeforderte Inhalte und Funktionen bereitstellen zu können. Dazu zählen etwa die Speicherung von
        Einstellungen sowie die Sicherstellung der Funktionalität und Sicherheit unseres Onlineangebots. Die
        Einwilligung kann jederzeit widerrufen werden. Wir informieren klar über deren Umfang und welche Cookies genutzt
        werden.</p>
      <p><strong>Hinweise zu datenschutzrechtlichen Rechtsgrundlagen: </strong>Ob wir personenbezogene Daten mithilfe
        von Cookies verarbeiten, hängt von einer Einwilligung ab. Liegt eine Einwilligung vor, dient sie als
        Rechtsgrundlage. Ohne Einwilligung stützen wir uns auf unsere berechtigten Interessen, die vorstehend in diesem
        Abschnitt und im Kontext der jeweiligen Dienste und Verfahren erläutert sind.</p>
      ...
      <ul class="m-elements">
        <li><strong>Verarbeitung von Cookie-Daten auf Grundlage einer Einwilligung: </strong>Wir setzen eine
          ...
          bezogen auf den Einsatz von Cookies und vergleichbaren Technologien, die zur Speicherung, zum Auslesen und zur
          Verarbeitung von Informationen auf den Endgeräten der Nutzer eingesetzt werden. Im Rahmen dieses Verfahrens
          werden die Einwilligungen der Nutzer für die Nutzung von Cookies und die damit verbundenen Verarbeitungen von
