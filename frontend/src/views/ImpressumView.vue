  ...
  <v-container class="pa-6">
    <v-card class="pa-6">
      <div class='impressum'><h1>Impressum</h1>
        ...
        <p>Kristoffer Götz <br>
          Brauneggerstrasse 3<br>
          78462 Konstanz <br>
        </p>
        ...
        <p><strong>Haftungsausschluss: </strong><br><br><strong>Haftung für Inhalte</strong><br><br>
          ...
          erklären Sie sich mit der Bearbeitung der über Sie erhobenen Daten durch Google in der zuvor beschriebenen Art
          und Weise und zu dem zuvor benannten Zweck einverstanden.</p><br>
      </div>
    </v-card>
  </v-container>
</template>
